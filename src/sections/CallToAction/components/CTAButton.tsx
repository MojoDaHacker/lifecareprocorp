export const CTAButton = () => {
  return (
    <div className="relative items-start self-stretch bg-no-repeat bg-cover box-border caret-transparent gap-x-[4%] flex flex-col justify-center max-w-full min-h-[75px] min-w-[4%] gap-y-5 w-full bg-center px-[5px] py-2.5 md:items-center md:min-h-2 md:gap-y-[30px] md:w-1/5 md:p-4">
